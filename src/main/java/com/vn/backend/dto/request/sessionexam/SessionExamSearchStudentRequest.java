...
@Data
public class SessionExamSearchStudentRequest {
  ...
  public SessionExamSearchStudentRequestDTO toDTO() {
    return SessionExamSearchStudentRequestDTO.builder()
        .classId( (this.classId == null || this.classId.isEmpty()) ? null : Long.parseLong(this.classId))
